...
# 1 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18F-J_DFP/1.5.44/xc8\\pic\\include\\inline.h" 1 3
...
# 505 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 1) && (d || (0 < p)
...
# 955 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
...

{
 char c;
    ...
    p = (0 <= prec) ? prec : 1;
    w = width;
# 981 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 2) && (d || (0 < p)
    ...
    || ((0 < w) && (flags & (1 << 1)))
        ...
        --i;
        c = d & 0x0f;
# 998 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
...
# 1023 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    return (void) pad(fp, &dbuf[i], w);
}
        ...
        while (!done) {
            switch ((*fmt)[0]) {
                ...
                case '0' :
                    ...
                    ++*fmt;
                    break;
# 1103 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
                default:
                    done = 1;
                    break;
            }
        }
# 1117 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
  width = read_prec_or_width(fmt, ap);
  if (width < 0) {
   flags |= (1 << 0);
   width = -width;
  }
# 1143 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
  cp = *fmt;
# 1213 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
  if (*cp == 'd' || *cp == 'i') {
# 1256 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
...
# 1321 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   convarg.uint = (vfpf_uint_t)(unsigned int)(*(unsigned int *)__va_arg(*(unsigned int **)ap, (unsigned int)0));

   *fmt = cp+1;
   switch (*cp) {
# 1335 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    case 'X':
